...
namespace EmployeeUI
{
	public partial class XtraEmployeeQuit : DevExpress.XtraEditors.XtraForm
	{
		...
		{
			if (MessageBox.Show(txtName.Text + " Personelini İşten Çıkartmak İstiyor " +
				$"Musunuz ?", "Persenol Çıkış İşlemi", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
			{
				var result = _employeeService.Get(employeeId);
