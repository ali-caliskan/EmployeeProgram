...
namespace EmployeeUI
{
	public partial class XtraOffDayList : DevExpress.XtraEditors.XtraForm
	{
		...
		{
			if (MessageBox.Show($"{(gridView1.GetFocusedRow() as OffDayDto).Name} Personelinin İzini Silmek İstiyor Musunuz?", "Onaylanıyor Musunuz", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
			{
